...
function bookMarkFull({ className }: SVGProps) {
  return (
...
function categoryTv({ className }: SVGProps) {
  return (
    <svg className={cn('h-6 w-6 fill-secondary', className)} xmlns='http://www.w3.org/2000/svg'>
      <path
...
function navHome({ className }: SVGProps) {
  return (
    <svg className={cn('h-6 w-6 fill-darkBlue', className)} xmlns='http://www.w3.org/2000/svg' viewBox='-0.5 0 21 20'>
...
function navMovies({ className }: SVGProps) {
  return (
    <svg className={cn('h-6 w-6 fill-darkBlue', className)} xmlns='http://www.w3.org/2000/svg' viewBox='-0.5 0 21 20'>
...
function navTvSeries({ className }: SVGProps) {
  return (
    <svg className={cn('h-6 w-6 fill-darkBlue', className)} xmlns='http://www.w3.org/2000/svg' viewBox='-0.5 0 21 20'>
...
function navBookmark({ className }: SVGProps) {
  return (
    <svg className={cn('h-6 w-6 fill-darkBlue', className)} xmlns='http://www.w3.org/2000/svg' viewBox='-2 0 21 20'>
...
function play({ className }: SVGProps) {
  return (
    <svg className={cn('h-6 w-6 fill-secondary', className)} xmlns='http://www.w3.org/2000/svg'>
      <path
...
function search({ className }: SVGProps) {
  return (
    <svg className={cn('h-6 w-6 fill-secondary', className)} xmlns='http://www.w3.org/2000/svg'>
      <path
...
function avatar({ className }: SVGProps) {
  return (
    <svg className={cn('h-8 w-8 fill-white', className)} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
