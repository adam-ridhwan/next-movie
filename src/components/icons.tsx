...
export const ImdbIcon = ({ className, id }: SVGProps) => (
  <a href={`https://www.imdb.com/title/${id}`} target='_blank' rel='noreferrer'>
    <svg
      ...
      xmlns='http://www.w3.org/2000/svg'
      className={cn(
        'size-8 fill-muted-foreground hover:fill-primary',
        className
      )}
    >
...
export const InstagramIcon = ({ className, id }: SVGProps) => (
  <a href={`https://www.instagram.com/${id}/`} target='_blank' rel='noreferrer'>
    <svg
      strokeWidth='0'
      viewBox='0 0 448 512'
      xmlns='http://www.w3.org/2000/svg'
...
export const TwitterIcon = ({ className, id }: SVGProps) => (
  <a href={`https://twitter.com/${id}/`} target='_blank' rel='noreferrer'>
    <svg
      strokeWidth='0'
      viewBox='0 0 512 512'
      xmlns='http://www.w3.org/2000/svg'
...
export const FacebookIcon = ({ className, id }: SVGProps) => (
  <a href={`https://twitter.com/${id}/`} target='_blank' rel='noreferrer'>
    <svg
      strokeWidth='0'
      viewBox='0 0 512 512'
...
export const VercelIcon = ({ className }: SVGProps) => (
  <svg
    ...
    className={cn('h-5 fill-white', className)}
  >
...
export const GithubIcon = ({ className }: SVGProps) => (
  <svg
    ...
    className={cn('h-7 fill-primary/80 stroke-muted', className)}
  >
    <ellipse cx='1245.2' cy='1243.4' fill='none' rx='1217.6' ry='1246.5' />
